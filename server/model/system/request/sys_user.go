...
import (
	common "github.com/perlou/go-vue-admin/server/model/common/request"
...
type ChangeUserInfo struct {
	...
	HeaderImg    string                `json:"headerImg" gorm:"default:https://avatars.githubusercontent.com/u/12897436?v=4;comment:用户头像"` // 用户头像
